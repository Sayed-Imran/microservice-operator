...
import (
	...
	apiv1alpha1 "github.com/Sayed-Imran/microservice-operator/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=api.imran.dev.io,resources=microservices,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=api.imran.dev.io,resources=microservices/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=api.imran.dev.io,resources=microservices/finalizers,verbs=update
